...
function sliderScroll (container, position){
    let padding_container = parseFloat(window.getComputedStyle(container).getPropertyValue('padding-left')),
...
slider(recommendations_container, limit_recommendations, 0, recommendations_slider);
